...
> **日期**：2026-03-27 ｜ **範圍**：[future-roadmap.md](../architecture/future-roadmap.md) 五大藍圖、[vnext.md](../architecture/vnext.md)、[plan.md](../architecture/plan.md) 對比目前已實作的程式碼
...
|---|---|---|---|---|
| 1 | **vNext：候選研究層** | [vnext.md](../architecture/vnext.md) | ✅ 已實作 | ❌ 無 |
| 2 | **plan.md：語氣後處理** | [plan.md](../architecture/plan.md) | ✅ 已實作 | ❌ 無 |
| 3 | **plan.md：來源白名單** | [plan.md](../architecture/plan.md) | ✅ 已實作 | ❌ 無 |
| 4 | **plan.md：Canonical Digest 層** | [plan.md](../architecture/plan.md) | ✅ 已實作 | ❌ 無 |
| 5 | **plan.md：Email 通知 (Resend)** | [plan.md](../architecture/plan.md) | ✅ 已實作 | ❌ 無 |
| 6 | **plan.md：Dashboard 靜態站** | [plan.md](../architecture/plan.md) | ✅ 已實作 | ❌ 無 |
| 7 | **Radar 量價篩選** | [vnext.md](../architecture/vnext.md) + [radar.py](../../stock_research/radar.py) | ⚠️ 原型階段 | ❌ 無 |
| 8 | **跨市場產業鏈共振追蹤器** | [future-roadmap.md](../architecture/future-roadmap.md) #1 | ❌ 未開始 | ❌ 無 |
| 9 | **例外管理量化儀表板** | [future-roadmap.md](../architecture/future-roadmap.md) #2 | ❌ 未開始 | ❌ 無 |
| 10 | **預期差量化計分板** | [future-roadmap.md](../architecture/future-roadmap.md) #3 | ❌ 未開始 | ❌ 無 |
| 11 | **決策回測「驗屍」資料庫** | [future-roadmap.md](../architecture/future-roadmap.md) #4 | 🟡 基礎存在 | ❌ 無 |
| 12 | **敘事熱度/擁擠度指數** | [future-roadmap.md](../architecture/future-roadmap.md) #5 | ❌ 未開始 | ❌ 無 |
...
這些功能在 [plan.md](../architecture/plan.md) 和 [vnext.md](../architecture/vnext.md) 中有規劃，且已完整實作並有測試覆蓋：
...
| 項目 | 狀態 |
|---|---|
| [stock_research/radar.py](../../stock_research/radar.py) | 存在，只有 40 行的 yfinance 腳本，只做 52 週新高距離計算 |
| [vnext.md](../architecture/vnext.md) 規劃 | 「少量量價篩選結果」作為候選進件的第三種來源 |
| `state.json` 欄位 | `radar_flags[]`、`radar_summary`、`radar_risk_level` 已在 contract 中 |
| 與 pipeline 的整合 | ❌ [radar.py](../../stock_research/radar.py) 結果未自動進入候選研究流程 |

**缺失清單**：
- [ ] [radar.py](../../stock_research/radar.py) 需要升級：增加更多量化指標（均線乖離、爆量偵測、動能指標）
...
### ❌ #8 — 跨市場產業鏈共振追蹤器（future-roadmap.md #1）

**figureout 描述**：定義 `US-MSFT → TW-Server-SupplyChain` 關聯樹，當美股龍頭打破 Threshold 時，預判資金轉向台股的「時間差紅利」。

**目前資產**：完全沒有任何程式碼或設定。[vnext.md](../architecture/vnext.md) 明確排除：「台股資料源、跨市場供應鏈映射」不進核心目標。
...
### ❌ #9 — 例外管理量化儀表板（future-roadmap.md #2）
...
### ❌ #10 — 預期差量化計分板（future-roadmap.md #3）
...
- 完全沒有程式碼
- 無台股資料源
- [vnext.md](../architecture/vnext.md) 已排除台股
...
### 🟡 #11 — 決策回測「驗屍」資料庫（future-roadmap.md #4）
...
### ❌ #12 — 敘事熱度與擁擠度指數（future-roadmap.md #5）
