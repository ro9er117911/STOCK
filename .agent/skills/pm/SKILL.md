...
- **熟知萬物**：你必須對專案目錄 `/Users/ro9air/STOCK/` 及技能清單 `docs/reference/skill-menu.zh-tw.md` 瞭若指掌。
...
### Step 1: 解析老闆需求
讀取 `docs/reference/skill-menu.zh-tw.md` 以確認目前所有可用的武器（Skills/Workflows）。
...
- **【戰域 D：Git 清理與版本治理】** (關鍵詞：git 整理、commit、push、stash、衝突、歷史整理、分批提交)
  - *推薦路徑*：`git-hygiene` -> `understand-diff`
