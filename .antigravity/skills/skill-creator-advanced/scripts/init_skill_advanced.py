...
## Common error checks
- [ ] No missing local paths referenced from `SKILL.md`
...
def main() -> int:
    ...
    print("2) Fill out references/quality_checklist.md and keep it updated during validation")
    print("3) Add scripts/references/assets as needed")
    print("4) Run format/structure checks (format_check.py + quick_validate.py)")
    print("5) Package with package_skill.py")
    return 0
